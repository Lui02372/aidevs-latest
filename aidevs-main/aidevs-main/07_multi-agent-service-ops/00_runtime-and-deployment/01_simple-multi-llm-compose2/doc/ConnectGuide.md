...
.\launcher.cmd -Target 01-2 -Action init
notepad .\01_simple-multi-llm-compose2\.env
.\launcher.cmd -Target 01-2 -Action check
.\launcher.cmd -Target 01-2 -Action start
.\launcher.cmd -Target 01-2 -Action status
~~~
...
~~~powershell
.\launcher.cmd -Target 01-2 -Action logs
.\launcher.cmd -Target 01-2 -Action stop
~~~
...
~~~powershell
Set-Location .\01_simple-multi-llm-compose2
...
.\.venvs\compose\Scripts\python.exe -m pytest .\01_simple-multi-llm-compose2\backend -q
~~~
