...
.\launcher.cmd -Target 01-3 -Action init
notepad .\01_simple-multi-llm-compose3\.env
.\launcher.cmd -Target 01-3 -Action check
.\launcher.cmd -Target 01-3 -Action start
.\launcher.cmd -Target 01-3 -Action status
~~~
...
~~~powershell
.\launcher.cmd -Target 01-3 -Action logs
.\launcher.cmd -Target 01-3 -Action stop
~~~
...
~~~powershell
Set-Location .\01_simple-multi-llm-compose3
...
.\.venvs\compose\Scripts\python.exe -m pytest .\01_simple-multi-llm-compose3\backend -q
~~~
