...
~~~powershell
Set-Location .\07_integrated-bedrock-mcp
...
07의 실제 OIDC·S3·SSM 배포 설정은 [04의 07 배포 경로](../../04_github-actions-aws-deploy/doc/ConnectGuide.md#07-oidcssm-배포-권장)에 정리했습니다.
IAM 정책은 [기존 정책 템플릿](../deploy/iam-policies.md)을 사용합니다.
서버 .env 위치는 /opt/weather-07/shared/.env입니다.
07은 8501과 8000이 127.0.0.1에만 바인딩되어 EC2 Public IP로 바로 열리지 않습니다.
[03 가이드](../../03_aws-ec2/doc/ConnectGuide.md)의 SSH 포트 포워딩으로 접속하세요.
Windows DB GUI 연결은 [Windows DB 안내](../WINDOWS_DATABASE_GUIDE.md)를 참고합니다.
