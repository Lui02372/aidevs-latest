## Project Player 연결 안내
Python 예제: 과정 루트 .venv · 공통 모듈: shared
공통 Docker 준비: PostgreSQL 15433(영구 저장) · Redis 16379(Queue/진행 상태)
로컬 LLM: Ollama 11434 · 08 서비스 버튼: MCP 18010 → Backend 18108 → Frontend 18508
아래 원본 문서의 기본 포트와 Player 전용 포트는 다릅니다. 외부 API·AWS·GitHub 계정 연결은 문서에서 필요한 단계를 구분해 확인하세요.
